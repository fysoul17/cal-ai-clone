...
5. Generate summary report with file:line references
6. Block approval if any CRITICAL or HIGH issues remain unfixed
</procedure>
...
- BLOCKED if any CRITICAL or HIGH issues remain unfixed
